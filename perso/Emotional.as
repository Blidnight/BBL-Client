   ...
   public class Emotional extends Walker
   {
      ...
      public function talk(param1:String, param2:uint = 0) : *
      {
         ...
         if(this.camera)
         {
            ...
            this.placeOnFront();
            _loc4_ = this.externalLoader.getClass("BubbleSound");
            _loc5_ = new _loc4_();
            _loc5_.play(0,0,new SoundTransform(this.camera.quality.actionVolume));
         }
      }
      ...
      override public function get walkSpeed() : Number
      {
         ...
         if(this._camera)
         {
            if(this._camera.currentMap)
            {
               _loc1_ = _loc1_ * this._camera.currentMap.walkSpeed;
            }
         }
         return _loc1_;
      }
