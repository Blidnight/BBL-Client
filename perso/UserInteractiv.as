package perso
{
   ...
   public class UserInteractiv extends UserIcon
   {
      ...
      private function updateHeadLocation() : *
      {
         ...
         else if(this._headLocation && !this._headLocationRefList.length)
         {
      ...
      private function updateItemPosition() : *
      {
         ...
         _loc1_ = _loc1_ - this.pseudoTextField.height;
      ...
      public function set sex(param1:uint) : *
      {
         this._sex = param1;
         this.pseudo = this.pseudo;
         bulle.fontColor = param1 == 0?uint(uint(16119285)):param1 == 1?uint(uint(13421823)):uint(uint(16765183));
      }
      ...
      public function set pseudo(param1:String) : *
      {
         ...
         if(overPseudo)
         {
            ...
            {
               param1 = param1 + overPseudo.pseudoValue;
            }
         ...
         var _loc2_:Number = this.sex == 0?Number(Number(15658734)):this.sex == 1?Number(Number(12636415)):Number(Number(16109813));
      ...
      {
         var _loc2_:* = null;
         var _loc3_:* = jump != param1;
         super.jump = param1;
         if(_loc3_ && param1 == -1 && this._interactivId.v && !shiftKey)
         {
            _loc2_ = new WalkerPhysicEvent("interactivEvent");
            _loc2_.walker = this;
            _loc2_.lastColor = 0;
            _loc2_.newColor = this._interactivId.v;
            _loc2_.certified = true;
            this.dispatchEvent(_loc2_);
         }
         if(_loc3_ && param1 == -1 && onFloor && walk == 0 && shiftKey && clientControled && camera && GlobalProperties.mainApplication.userInterface)
         {
