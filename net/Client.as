package net
{
   ...
   public class Client extends SocketAdv
   {
      ...
      override public function eventMessage(param1:SocketMessageEvent) : *
      {
         ...
         this.parsedEventMessage(_loc2_,_loc3_,param1);
      ...
      public function parsedEventMessage(param1:uint, param2:uint, param3:SocketMessageEvent) : *
      {
         ...
         if(param1 == 1)
         {
            ...
            {
               _loc4_ = new TextEvent("onFatalAlert");
               _loc4_.text = unescape(param3.message.bitReadString());
            ...
            else if(param2 == 4)
            {
               ...
               {
                  _loc6_ = new Transport();
                  _loc6_.readBinary(param3.message);
                  this.transportList.push(_loc6_);
               }
               this.mapList.splice(0,this.mapList.length);
               while(param3.message.bitReadBoolean())
               {
                  _loc7_ = new ServerMap();
                  _loc7_.id = param3.message.bitReadUnsignedInt(GlobalProperties.BIT_MAP_ID);
               ...
               {
                  _loc10_ = new Server();
                  _loc10_.nom = param3.message.bitReadString();
               ...
               _loc5_ = uint(param3.message.bitReadUnsignedInt(8));
            ...
            else if(param2 != 8)
            {
               ...
               {
                  _loc13_ = uint(param3.message.bitReadUnsignedInt(GlobalProperties.BIT_CHANNEL_ID));
               ...
               else if(param2 == 18)
               {
                  ...
                  _loc17_ = new SocketMessage();
                  _loc17_.bitWriteUnsignedInt(GlobalProperties.BIT_TYPE,1);
      ...
      public function serverTimeMessage(param1:SocketMessageEvent) : *
      {
         ...
         _loc2_ = _loc2_ + param1.message.bitReadUnsignedInt(10);
         var _loc3_:uint = new Date().getTime() - this.serverTimePing;
         _loc2_ = _loc2_ - Math.round(_loc3_ / 2);
