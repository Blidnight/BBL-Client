package map
{
   ...
   public class RainEffect
   {
      ...
      public function getCurrentSnowFactor() : Number
      {
         ...
         var _loc2_:Number = this.temperature < 0.5?Number(Number(1)):Number(Number(0));
      ...
      public function step(param1:Event = null) : *
      {
         ...
         if(this.rainSndClass)
         {
            ...
            {
               _loc4_ = Number(this.getCurrentRainFactor());
            }
            _loc2_ = 0;
            while(_loc2_ < this.rainSndChannelNum)
            {
               ...
               _loc8_ = (_loc4_ - _loc6_) / (_loc7_ - _loc6_);
               if(_loc8_ > 0)
               {
      ...
      public function redraw() : *
      {
         ...
         var _loc10_:BitmapData = new BitmapData(_loc1_.width + _loc9_.blurX * 2,_loc1_.height + _loc9_.blurY * 2,true,0);
         _loc10_.copyPixels(_loc1_,_loc1_.rect,new Point(_loc9_.blurX,_loc9_.blurY),null,null,true);
