package map
{
   ...
   public class FogEffect
   {
      ...
      public function redraw() : *
      {
         ...
         {
            _loc2_ = uint(Math.max(_loc2_,this.itemList[_loc3_].plan));
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.itemList.length)
         {
            this.itemList[_loc3_].target.getChildAt(0).alpha = this.fogDensity * 0.4 * (this.itemList[_loc3_].plan / _loc2_ * 0.3 + 0.7);
            _loc3_++;
         }
      }
   }
