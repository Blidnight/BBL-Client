package engine
{
   ...
   public class JPEGEncoder
   {
      ...
      private function initQuantTables(param1:int) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc8_:int = 0;
         var _loc5_:* = [16,11,10,16,24,40,51,61,12,12,14,19,26,58,60,55,14,13,16,24,40,57,69,56,14,17,22,29,51,87,80,62,18,22,37,56,68,109,103,77,24,35,55,64,81,104,113,92,49,64,78,87,103,121,120,101,72,92,95,98,112,100,103,99];
         _loc2_ = 0;
         while(_loc2_ < 64)
         {
         ...
         var _loc6_:* = [17,18,24,47,99,99,99,99,18,21,26,66,99,99,99,99,24,26,56,99,99,99,99,99,47,66,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99];
         _loc2_ = 0;
         while(_loc2_ < 64)
         {
            _loc3_ = Number(Math.floor((_loc6_[_loc2_] * param1 + 50) / 100));
            if(_loc3_ < 1)
            {
               _loc3_ = 1;
            }
         ...
         var _loc7_:* = [1,1.387039845,1.306562965,1.175875602,1,0.785694958,0.5411961,0.275899379];
         _loc2_ = 0;
         while(_loc8_ < 8)
         {
            _loc4_ = 0;
      ...
      private function fDCTQuant(param1:Array, param2:Array) : Array
      {
         ...
         while(_loc22_ < 8)
         {
            ...
            _loc4_ = param1[_loc23_ + 0] - param1[_loc23_ + 7];
            _loc5_ = param1[_loc23_ + 1] + param1[_loc23_ + 6];
            _loc6_ = param1[_loc23_ + 1] - param1[_loc23_ + 6];
            _loc7_ = param1[_loc23_ + 2] + param1[_loc23_ + 5];
            _loc8_ = param1[_loc23_ + 2] - param1[_loc23_ + 5];
            _loc9_ = param1[_loc23_ + 3] + param1[_loc23_ + 4];
            _loc10_ = param1[_loc23_ + 3] - param1[_loc23_ + 4];
            _loc11_ = _loc3_ + _loc9_;
            _loc12_ = _loc3_ - _loc9_;
            _loc13_ = _loc5_ + _loc7_;
            _loc14_ = _loc5_ - _loc7_;
            param1[_loc23_ + 0] = _loc11_ + _loc13_;
            param1[_loc23_ + 4] = _loc11_ - _loc13_;
            _loc15_ = (_loc14_ + _loc12_) * 0.707106781;
            param1[_loc23_ + 2] = _loc12_ + _loc15_;
            param1[_loc23_ + 6] = _loc12_ - _loc15_;
            ...
            param1[_loc23_ + 5] = _loc21_ + _loc17_;
            param1[_loc23_ + 3] = _loc21_ - _loc17_;
         ...
         while(_loc22_ < 8)
         {
            ...
            _loc4_ = param1[_loc23_ + 0] - param1[_loc23_ + 56];
            _loc5_ = param1[_loc23_ + 8] + param1[_loc23_ + 48];
            _loc6_ = param1[_loc23_ + 8] - param1[_loc23_ + 48];
            _loc7_ = param1[_loc23_ + 16] + param1[_loc23_ + 40];
            _loc8_ = param1[_loc23_ + 16] - param1[_loc23_ + 40];
            _loc9_ = param1[_loc23_ + 24] + param1[_loc23_ + 32];
            _loc10_ = param1[_loc23_ + 24] - param1[_loc23_ + 32];
            _loc11_ = _loc3_ + _loc9_;
            _loc12_ = _loc3_ - _loc9_;
            _loc13_ = _loc5_ + _loc7_;
            _loc14_ = _loc5_ - _loc7_;
            param1[_loc23_ + 0] = _loc11_ + _loc13_;
            param1[_loc23_ + 32] = _loc11_ - _loc13_;
            _loc15_ = (_loc14_ + _loc12_) * 0.707106781;
            param1[_loc23_ + 16] = _loc12_ + _loc15_;
            param1[_loc23_ + 48] = _loc12_ - _loc15_;
            _loc11_ = _loc10_ + _loc8_;
            _loc13_ = _loc8_ + _loc6_;
            _loc14_ = _loc6_ + _loc4_;
            _loc16_ = (_loc11_ - _loc14_) * 0.382683433;
            ...
            _loc20_ = _loc4_ + _loc19_;
            _loc21_ = _loc4_ - _loc19_;
            param1[_loc23_ + 40] = _loc21_ + _loc17_;
            param1[_loc23_ + 24] = _loc21_ - _loc17_;
      ...
      private function processDU(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         while(_loc9_ < 64)
         {
            this.DU[this.ZigZag[_loc9_]] = _loc12_[_loc9_];
            _loc9_++;
         }
         ...
         {
            _loc6_ = _loc9_;
            while(this.DU[_loc9_] == 0 && _loc9_ <= _loc14_)
            {
               _loc9_++;
            }
            ...
            {
               _loc8_ = 1;
               while(_loc8_ <= _loc7_ / 16)
               {
                  this.writeBits(_loc11_);
                  _loc8_++;
               }
               _loc7_ = int(_loc7_ & 15);
            }
            this.writeBits(param5[_loc7_ * 16 + this.category[32767 + this.DU[_loc9_]]]);
            this.writeBits(this.bitcode[32767 + this.DU[_loc9_]]);
            _loc9_++;
         }
         if(_loc14_ != 63)
         {
      ...
      private function RGB2YUV(param1:BitmapData, param2:int, param3:int) : *
      {
         ...
         while(_loc10_ < 8)
         {
            ...
            while(_loc4_ < 8)
            {
               _loc5_ = uint(param1.getPixel32(param2 + _loc4_,param3 + _loc10_));
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         while(_loc7_ < param1.height)
         {
            ...
            while(_loc2_ < param1.width)
            {
               ...
               _loc4_ = Number(this.processDU(this.YDU,this.fdtbl_Y,_loc4_,this.YDC_HT,this.YAC_HT));
               _loc5_ = Number(this.processDU(this.UDU,this.fdtbl_UV,_loc5_,this.UVDC_HT,this.UVAC_HT));
               _loc6_ = Number(this.processDU(this.VDU,this.fdtbl_UV,_loc6_,this.UVDC_HT,this.UVAC_HT));
               _loc2_ = _loc2_ + 8;
            }
            _loc7_ = _loc7_ + 8;
         }
