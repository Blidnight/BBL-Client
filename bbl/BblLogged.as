   ...
   public class BblLogged extends BblCamera
   {
      ...
      public function userSmileyEvent(param1:SocketMessage) : *
      {
         ...
         while(param1.bitReadBoolean())
         {
            ...
            if(_loc2_ == 0)
            {
               _loc3_ = uint(param1.bitReadUnsignedInt(GlobalProperties.BIT_SMILEY_PACK_ID));
               smileyAllowList.push(_loc3_);
               _loc4_ = true;
            }
         }
         if(_loc4_)
      ...
      override public function parsedEventMessage(param1:uint, param2:uint, param3:SocketMessageEvent) : *
      {
         ...
         {
            _loc5_ = uint(param3.message.bitReadUnsignedInt(GlobalProperties.BIT_ERROR_ID));
            ...
            _loc6_ = param3.message.bitReadString();
            _loc7_ = _loc6_.split("");
            _loc8_ = null;
            try
            {
            ...
            if(_loc7_.length > 2 && _loc8_)
            {
               _loc11_ = Number("0x" + _loc7_.shift() + _loc7_.shift());
               if(_loc11_)
               {
                  ...
                  {
                     _loc14_ = Number("0x" + _loc7_.shift() + _loc7_.shift());
                     if(_loc14_ < _loc8_.colorList.length)
                     {
                        _loc15_ = GlobalProperties.chatStyleSheet.getStyle(GlobalProperties.chatStyleSheetData[_loc11_][_loc13_]);
                        _loc15_.color = "#" + _loc8_.colorList[_loc14_][0].toString(16);
            ...
            _loc9_ = new ServerMap();
            _loc9_.serverId = serverId;
         ...
         {
            addBlackList(param3.message.bitReadUnsignedInt(GlobalProperties.BIT_USER_ID),param3.message.bitReadString());
            _loc4_ = new ContactEvent("onBlackListAdded");
            _loc4_.contact = blackList[friendList.length - 1];
         ...
         {
            addFriend(param3.message.bitReadUnsignedInt(GlobalProperties.BIT_USER_ID),param3.message.bitReadString());
            _loc4_ = new ContactEvent("onFriendAdded");
            _loc4_.contact = friendList[friendList.length - 1];
            dispatchEvent(_loc4_);
            this.dispatchEvent(new Event("onFriendListChange"));
         }
         ...
         {
            _loc16_ = new ParsedMessageEvent("onParsedMessage");
            _loc16_._message = param3.message;
