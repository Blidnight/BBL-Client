package bbl
{
   ...
   public class InterfaceBase extends MovieClip
   {
      ...
      public function set temperature(param1:Number) : *
      {
         ...
         if(this.thermo)
         {
            _loc2_ = uint(Math.round((this.thermo.totalFrames - 1) * param1 + 1));
      ...
      {
         this.ecran.y = !!this._textDeroule?Number(Number(this._ecranFirstPos)):Number(Number(this._ecranFirstPos - 200));
         this.btDerouleText.y = this.ecran.y;
         this.scroll.y = this.ecran.y + 3;
         this.ecran.height = !!this._textDeroule?Number(Number(this._ecranFirstHeight)):Number(Number(this._ecranFirstHeight + 200));
         this.scroll.size = this.ecran.height - 10;
         this.ecranBackground.y = !!this._textDeroule?Number(Number(this._ecranFirstPos)):Number(Number(this._ecranFirstPos - 200));
         this.ecranBackground.height = !!this._textDeroule?Number(Number(this._ecranBackgroundHeight)):Number(Number(this._ecranBackgroundHeight + 200));
         this.ecranBackground.alpha = !!this._textDeroule?Number(Number(1)):Number(Number(0.75));
      ...
      public function linkEvent(param1:TextEvent) : *
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc4_:* = param1.text.split("=");
         if(_loc4_[0] == "0")
         {
            _loc2_ = new InterfaceEvent("onSelectUser");
            _loc2_.pseudo = unescape(_loc4_[1]);
            _loc2_.pid = _loc4_[2];
            _loc2_.uid = _loc4_[3];
            _loc2_.serverId = _loc4_[4];
            dispatchEvent(_loc2_);
         }
         else if(_loc4_[0] == "1")
         {
            _loc4_.shift();
            _loc3_ = new TextEvent("onOpenAlert");
            _loc3_.text = _loc4_.join("=");
      ...
      public function KeyDown(param1:KeyboardEvent) : *
      {
         ...
         if(GlobalProperties.stage.focus == this.input)
         {
            ...
            else if(param1.keyCode == 38 && param1.ctrlKey && this.lastMsgList.length)
            {
            ...
            else if(param1.keyCode == 40 && param1.ctrlKey && this.lastMsgList.length)
            {
               this.lastMsgPos++;
         ...
         if(param1.length && !this.floodPunished && !this.scriptingLock)
         {
            ...
            if(_loc5_[0] == "/mp" || _loc5_[0] == "/w")
            {
               if(_loc5_.length > 2)
               {
                  ...
                  {
                     _loc4_ = new InterfaceEvent("onSendPrivateMessage");
                     _loc4_.pseudo = _loc5_[1];
                     _loc6_.shift();
                     _loc6_.shift();
            ...
            {
               _loc4_ = new InterfaceEvent("onWarEvent");
               _loc4_.text = "1";
               dispatchEvent(_loc4_);
               _loc3_ = true;
            }
            ...
            {
               _loc7_ = new TextEvent("onSendMessage");
               _loc7_.text = param1;
      ...
      public function addUserMessage(param1:String, param2:String, param3:Object = null) : *
      {
         ...
         else if(param3.ISMODO && param3.ISPRIVATE)
         {
         ...
         if(param3.ISPRIVATE && !param3.ISMODO)
         {
         ...
         if(param3.PID && !param3.ISMODO)
         {
            _loc4_[0] = _loc4_[0] + ("<U><A HREF=\'event:0=" + escape(param1) + "=" + param3.PID + "=" + param3.UID + "=" + param3.SERVERID + "\'>");
      ...
      public function updateLock() : *
      {
         ...
         this.input.backgroundColor = !!_loc1_?uint(uint(12303291)):uint(uint(16777215));
