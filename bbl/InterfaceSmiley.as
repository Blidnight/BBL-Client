   ...
   public class InterfaceSmiley extends InterfaceBase
   {
      ...
      public function openPackList(param1:Event) : *
      {
         ...
         if(this.packList.length)
         {
            ...
            _loc4_ = new RectArea();
            _loc4_.addEventListener(MouseEvent.MOUSE_DOWN,this.downInPackList,true,0,true);
            ...
            while(_loc5_ < this.packList.length)
            {
               ...
               _loc9_ = new RectArea();
               _loc9_.areaWidth = this.smileyContent.areaWidth;
               ...
               _loc6_ = Number(_loc6_ + (_loc9_.areaHeight + _loc2_));
               _loc3_.push(_loc6_);
               _loc5_++;
            }
            _loc7_ = Number(Math.min(300,_loc6_));
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:uint = Number(param1.currentTarget.name.split("_")[1]);
         _loc2_ = 0;
         while(_loc2_ < this.packList.length)
         {
            if(this.packList[_loc2_].loaderItem.id == _loc3_)
            {
               this.selectedPack = this.packList[_loc2_];
               break;
            }
            _loc2_++;
         }
