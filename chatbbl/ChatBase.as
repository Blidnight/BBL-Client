package chatbbl
{
   ...
   public class ChatBase extends MovieClip
   {
      ...
      public var assetsBridge:AssetsBridge;
      ...
      public function ChatBase()
      {
         ...
         this.dailyTimer = new Timer(3600000);
         ...
         this.multiTimer = new Timer(3000);
         ...
         this.winPopup.areaLimit.height = this.msgPopup.areaLimit.height = 360;
         this.winPopup.appearLimit.width = this.msgPopup.appearLimit.width = 550;
      ...
      {
         var _loc4_:* = new SocketMessage();
         _loc4_.bitWriteUnsignedInt(GlobalProperties.BIT_TYPE,1);
      ...
      public function initBlablaland() : *
      {
         ...
         var _loc1_:String = "params.xml";
         if(GlobalProperties.stage.loaderInfo.url.search(/^file:\/\/\//) == -1)
         {
            _loc1_ = _loc1_ + ("?&cache=" + new Date().getTime());
         }
         var _loc2_:URLRequest = new URLRequest(_loc1_);
         var _loc3_:URLLoader = new URLLoader();
         _loc3_.load(_loc2_);
         _loc3_.addEventListener("complete",this.onXmlReady,false,0,true);
      }
      ...
      public function keepAliveEvent(param1:Event = null) : *
      {
         ...
         var _loc4_:URLRequest = new URLRequest(GlobalProperties.scriptAdr + "chat/keepalive.php");
         _loc4_.method = "POST";
         _loc4_.data = _loc3_;
         var _loc5_:URLLoader = new URLLoader();
         _loc5_.dataFormat = "variables";
         _loc5_.load(_loc4_);
      ...
      public function addStats(param1:uint, param2:String) : *
      {
         ...
         _loc3_.VAL = param2;
         _loc3_.TYPE = param1;
         var _loc4_:URLRequest = new URLRequest(GlobalProperties.scriptAdr + "chat/usersStats.php");
         _loc4_.method = "POST";
         _loc4_.data = _loc3_;
         var _loc5_:URLLoader = new URLLoader();
         _loc5_.load(_loc4_);
      ...
      {
         this.nbFxToLoad = this.nbFxToLoad - (!!param1?1:0);
      ...
      public function setLoadingClip(param1:Boolean, param2:uint = 0) : *
      {
         ...
         if(param1 && !this.loadingClip)
         {
            ...
            this.loadingClip.x = Math.round(475);
         }
         ...
         if(this.loadingClip)
         {
            _loc3_ = stage.loaderInfo.parameters.DAILYMSG;
            if(!_loc3_)
            {
               _loc3_ = "";
            }
