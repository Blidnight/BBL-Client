package chatbbl
{
   ...
   public class ChatInterface extends ChatBase
   {
      ...
      {
         this.updateKdoTimer.delay = 120000;
      ...
      override public function setLoadingClip(param1:Boolean, param2:uint = 0) : *
      {
         ...
         if(loadingClip)
         {
            if(param2 == 1)
            {
               _loc3_ = stage.loaderInfo.parameters.DAILYMSGSECU;
               if(_loc3_ && this.userInterface)
               {
                  this.userInterface.addLocalMessage("<span class=\'dailymsgsecu\'>Bienvenue sur Blablaland.fun !\nRappel de sécurité : " + _loc3_ + "</span>");
               }
            }
         }
      }
      ...
      {
         var _loc2_:ClickOptionItem = this.userOptionAction.addChild(param1);
         return _loc2_;
      }
      ...
      public function clickUser(param1:uint, param2:String) : *
      {
         ...
         while(_loc3_ < this.userOption.childList.length)
         {
            ...
            if(this.userOption.childList[_loc3_].visible && !this.userOption.childList[_loc3_].data.hideForSelf)
            {
               _loc4_++;
            }
            _loc3_++;
         ...
         while(_loc3_ < this.userOptionAction.childList.length)
         {
            ...
            if(this.userOptionAction.childList[_loc3_].visible && !this.userOptionAction.childList[_loc3_].data.hideForSelf)
            {
               _loc4_++;
            }
            _loc3_++;
      ...
      public function openServerSelector(param1:Object) : Object
      {
         ...
         var _loc4_:FxLoader = new FxLoader();
         _loc4_.clearInitData = false;
      ...
      {
         navigateToURL(new URLRequest("/account"),"_blank");
      }
      ...
      public function onInterfaceSendPrivateMessage(param1:InterfaceEvent) : *
      {
         ...
         if(!blablaland.uid)
         {
            this.userInterface.addLocalMessage("<span class=\'info\'>Les touristes ne peuvent pas parler. Vous devez <U><A HREF=\'/register\' TARGET=\'_self\'>créer un compte</A></U>.</span>");
         }
         else
         {
      ...
      public function onInterfaceSmile(param1:SmileyEvent) : *
      {
         ...
         if(!blablaland.uid)
         {
            this.userInterface.addLocalMessage("<span class=\'info\'>Les touristes ne peuvent pas faire de smiley. Vous devez <U><A HREF=\'/register\' TARGET=\'_self\'>créer un compte</A></U>.</span>");
         }
